...
from package.contextos import demolicoes
...
menu_do_ambiente.bake_json(ifc_ambientes, ifc_etapas_por_id, ifc_projeto)
...
demolicoes.bake_json(ifc_ambientes, ifc_etapas_por_id, ifc_projeto)
